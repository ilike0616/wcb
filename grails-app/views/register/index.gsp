...
<div class="header_login">
    <div class="logo"><a href="http://www.xiaoshouwuyou.com/"></a>
        <span class="logo_title"><img src="http://www.xiaoshouwuyou.com/images/logo_title.gif" width="219" height="23" /></span>
        <span class="return_home"><a href="http://www.xiaoshouwuyou.com/index.html"><img src="http://www.xiaoshouwuyou.com/images/logo_return.gif" width="43" height="43" border="0"/></a></span>
    </div>
</div>
<div class="clear"></div>
...
<div class="registered_main_box">
    ...
    <div class="registered_main_bar"><img src="http://www.xiaoshouwuyou.com/images/registered_main_bar1.gif" width="721" height="68" /></div>
    <div class="registered_main_form">
        ...
        <div class="registered_main_form_right">
            <form class="regForm" method="post" action="${createLink(controller: 'register',action: 'auth')}">
                <table border="0" cellspacing="5" cellpadding="0">
                    <tr>
                        <td colspan="2">
                            <input  type="text" id="mobile" name="mobile" value="${params.mobile}" placeholder="请输入手机号码" ajaxurl="${createLink(controller: 'register',action: 'uniqueMobile')}" datatype="m"  errormsg="请输入您的手机号码！"  nullmsg="手机号码必须填写！"/>
                            <div class="Validform_checktip" style="display:none"></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input  type="text" name="captcha" placeholder="请输入识别码" datatype="*"  ajaxurl="${createLink(controller: 'captcha',action: 'validate')}" errormsg="验证码是4位" nullmsg="识别码必须输入！" maxlength="4"/>
                            <div class="Validform_checktip" style="display:none"></div>
                        </td>
                        <td>
                            <img src="${createLink(controller: 'captcha')}" width="79" id="imageCaptcha" height="36" onclick="reloadCaptcha();" />
                            <img src="http://www.xiaoshouwuyou.com/images/registered_main_sbm2.gif" width="43"  onclick="reloadCaptcha();" height="36" onclick="reloadCaptcha();"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input  type="text" id="verify" name="verify" placeholder="请输入手机验证码"  datatype="*"  nullmsg="手机验证码必须输入！"/>
                            <div class="Validform_checktip" style="display:none"></div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2"><img src="http://www.xiaoshouwuyou.com/images/registered_main_button01.gif" id="btn_submit" width="90" height="34" style="margin-left:16px; vertical-align: baseline;" />
...
<script type="text/javascript" src="http://www.xiaoshouwuyou.com/js/Validform/plugin/passwordStrength/passwordStrength-min.js"></script>
...
//            console.info(reg.setStatus('normal'));
            if(!verifyCountdown()){
                return;
            }
            reg.ignore("#verify");
            if(reg.check(false)==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: '${createLink(controller: 'register',action: 'uniqueMobile')}' ,
