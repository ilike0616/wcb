        ...
        <div class="share_main">
            <ul>
                ...
                <li>
                    <label>分享摘要：</label>
                    <i id="htmlContent">
                        <g:if test="${share.urlType == 1}">
                            ${share.content}
                        </g:if>
                        <g:else>
                            ${share.htmlContent.decodeHTML()}
                        </g:else>
                    </i>
                </li>
                <li><label>分享URL地址：</label><i>${share.url}</i></li>
                <li>
                    <label>分享图片：</label>
                ...
                <li>
                    ...
                    <i>
                        ...
                        <script type="text/javascript">
                            var sharePic = "";
                            if(${share.pic != null && share.pic != ''}){
                                sharePic = "${grailsApplication.config.HTTP_FILE_URL}/${share.pic?.name}";
                            }else{
                                sharePic = "${grailsApplication.config.HTTP_FILE_URL}/defaultSharePic.gif";
                            }
                            window._bd_share_config = {
                                common : {
                                    bdText : '${share.subject}',
                                    bdDesc : '${share.content}',
                                    bdUrl : '${share.url}',
                                    bdPic : sharePic,
                                    onAfterClick:function(cmd){
                                        ...
                                        $.ajax({
                                            ...
                                            dataType: 'json',
                                            url: 'share/share' ,
                                            data: {shareId:shareId,shareTo:cmd} ,
                                            async:true,
