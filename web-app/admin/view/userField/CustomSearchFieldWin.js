 ...
 */
Ext.define('admin.view.userField.CustomSearchFieldWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.customSearchFieldWin',
    ...
    searchField : function(o,from){  // 查询可选字段
        var me = this;
        var win = o.up("customSearchFieldWin");
    ...
    confirm : function(o, e, eOpts){    // 确定
        ...
        if(checkedValue != null && checkedValue != 'undefined'){
            ...
            this.GridDoActionUtil.doAjax('userField/enableSearchField',checkedValue,me.store);
            me.close();
        }else{
