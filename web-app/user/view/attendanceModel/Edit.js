Ext.define("user.view.attendanceModel.Edit",{
    extend: 'Ext.window.Window',
    alias: 'widget.attendanceModelEdit',
    modal: true,
    width: 700,
    layout: 'anchor',
    title: '修改考勤模板',
            ...
            items: [
                {
                    ...
                    buttons: [{
                        text:'保存',itemId:'save',iconCls:'table_save',autoUpdate:true,target:'attendanceModelList'
                    }]
                }
            ]
        });
