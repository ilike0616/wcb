Ext.define("user.view.attendanceModel.View",{
    extend: 'Ext.window.Window',
    alias: 'widget.attendanceModelView',
    modal: true,
    width: 700,
    layout: 'anchor',
    title: '查看考勤模板',
            ...
            items: [
                {
                    ...
                    buttons: [{
                        text:'关闭',itemId:'save',iconCls:'cancel',autoClose:true
                    }]
                }
            ]
        });
