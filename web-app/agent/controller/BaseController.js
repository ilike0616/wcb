 ...
 */
Ext.define('agent.controller.BaseController', {
        ...
        this.control({
            ...
            'baseList':{
            	 select:function(selectModel, record, index, eOpts){
                     ...
                     Ext.Array.forEach(eOpts.up('baseList').query('button[autodisabled=true]'),function(o,index){
                    ...
                    Ext.Array.forEach(eOpts.up('grid').query('button[autodisabled=true]'),function(o,index){
