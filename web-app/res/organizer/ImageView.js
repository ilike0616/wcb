...
Ext.define('Ext.org.ImageView', {
    ...
    tpl: [
        '<tpl for=".">',
            '<div class="thumb-wrap">',
                '<div class="thumb">',
                    (!Ext.isIE6? '<img src="ext-4.2.1/examples/view/chooser/icons/{thumb}" />' :
    ...
    initComponent: function() {
        this.store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url : 'ext-4.2.1/examples/view/chooser/icons.json',
                reader: {
                    type: 'json',
                    root: ''
                }
        ...
        this.mixins.draggable.init(this, {
            ...
            ghostTpl: [
                '<tpl for=".">',
                    '<img src="ext-4.2.1/examples/view/chooser/icons/{thumb}" />',
