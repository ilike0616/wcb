...
Ext.define('public.uploadPanel.BaseUploadImageField', {
    extend: 'Ext.form.Panel',
    alias: 'widget.baseUploadImageField',
    store : Ext.create('Ext.data.JsonStore',{
        autoLoad : false,
        fields : ['id','name','type','size','percent','status','fileName','docSeed','httpFilePath']
    }),
    layout: 'anchor',
    border: 0,
    defaults: {
    ...
    upload_success_handler : function(file, serverData, responseReceived){  // 上传成功时
        ...
        if(serverResult.success){
            ...
            rec.set('httpFilePath',serverResult.httpFilePath);
        }else{
            rec.set('docSeed',0);
        }
        rec.commit();
    ...
    showUploadFiles : function () {
        ...
        for(var i=0;i<store.getCount();i++) {
            ...
            if(docSeed!="" && docSeed != 0){
                docSeedMap.add(docSeed,record.get('httpFilePath'));
                ...
                fileNames.push({
                    ...
                    items: [{
                        ...
                        items:[{
                            xtype: 'component',
                            html: "<a href='"+downloadUrl+"' target='_target'>下载&nbsp;|</a>"
                        },{
                            xtype: 'component',
    ...
    generateHiddenField : function(o){
        ...
        var hiddenFieldId = {
            ...
            itemId : 'tempBaseUploadImageFieldHidden_'+me.hiddenName,
