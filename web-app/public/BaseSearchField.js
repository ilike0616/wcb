/**
 * Created by guozhen on 2014/9/17.
 */
Ext.define('public.BaseSearchField', {
    extend: 'Ext.form.field.Trigger',

    alias: 'widget.baseSearchField',
    ...
    onTrigger2Click : function(){
        ...
        if (value.length > 0) {
            ...
            if(me.store.filters){
                var keys = me.store.filters.keys
                if(Ext.Array.contains(keys,me.paramName)){
                    me.store.clearFilter();
                    me.hasSearch = false;
                    me.triggerCell.item(0).setDisplayed(false);
                    me.updateLayout();
